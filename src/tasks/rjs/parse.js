...
// DKB Added this
var requireArray = ["require", "requirejs", "requireConfig", "requirejsConfig"];
...
//define(['./esprimaAdapter', 'lang'], function (esprima, lang) {
    ...
    function parse(moduleName, fileName, fileContents, options) {
        ...
        parse.recurse(astRoot, function (callName, config, name, deps) {
            ...
            // already a define, but also a require, not a require file
            // need to signal as much
            // DKB Added this
            if ( !needsDefine && requireArray.indexOf( callName ) > -1 ) {
              moduleDeps.push("NESTEDREQUIRE");
            }
        ...
        */
        ...
        // DKB: Added to return more useful data


        if (moduleList.length) {
          for (i = 0; i < moduleList.length; i++) {
            moduleCall = moduleList[i];
            moduleDeps = moduleDeps.concat(moduleCall.deps);
          }
        }

        return moduleDeps;

        // return depString || null;
    }
    ...
    parse.findConfig = function (fileContents) {
        ...
        // DKB want to know if has require
        var requireCount = 0;
        ...
        return {
            ...
            //range: foundRange,
            //quote: quote,
            requireCount: requireCount // DKB added
        };
    };
