...
module.exports = RequireRegister = (function() {
  ...
  */
  ...
  RequireRegister.prototype._depIsOk = function(dep) {
    return dep === 'require' || dep === 'module' || dep === 'exports' || this.config.require.safeDeps.indexOf(dep) > -1;
  };
