"use strict";
var config, fs, logger, path, startupFilesProcessed, trackKeys, trackingFilePath, trackingInfo, wrench, _, _createEmptyTrackingInfo, _getFiles, _removeFileFromObjectKey, _removeFileFromTracking, _setNewPathValues, _setVals, _tryFileWrite, _validateAndSetTrackingInfo, _writeTrackingObject;
...
exports.requireFiles = function(_requireFiles) {
  ...
  _requireFiles.forEach(function(f) {
    ...
    return trackingInfo.requireFiles.push(truncPath);
  });
